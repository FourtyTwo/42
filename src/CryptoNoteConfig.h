...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1cbd67;
...
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1531612950;
...
const char     LATEST_VERSION_URL[]                          = "http://coin42.co";
