...
const uint32_t UPGRADE_HEIGHT_CURRENT                        = UPGRADE_HEIGHT_V4; // im dumb :(
...
{
    {  0x23, 0xcc, 0x22, 0x42, 0x98, 0xdd, 0xdd, 0x55, 0x92, 0x32, 0xaa, 0x42, 0xb3, 0x13, 0x42, 0x42  } // need a babel fish?
};

const char* const SEED_NODES[] = {
  "35.229.97.217:4200", // node1
  "104.196.199.87:4200", // node2
